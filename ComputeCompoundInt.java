 ...
 * @author USER
 */
@WebServlet(name = "ComputeCompoundInt", urlPatterns = {"/ComputeCompoundInt"})
public class ComputeCompoundInt extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ComputeCompoundInt</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ComputeCompoundInt at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//        processRequest(request, response);
        ...
        double CI = p * Math.pow((1 + r / y), (y * t));
